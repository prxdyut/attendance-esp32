...
export default function SideBar() {
  ...
  const SideBarItems: SideBarItem[] = [
    ...
    { type: "link", label: "New Cards", url: "/new-cards", icon: <></> },
    { type: "link", label: "Presentees", url: "/presentees", icon: <></> },
    { type: "link", label: "Absentees", url: "/absentees", icon: <></> },
    { type: "link", label: "Schedules", url: "/schedules", icon: <></> },
    { type: "link", label: "Scores", url: "/scores", icon: <></> },
    { type: "link", label: "Fees", url: "/fees", icon: <></> },
    { type: "link", label: "Alerts", url: "/alerts", icon: <></> },
    { type: "link", label: "Resources", url: "/resources", icon: <></> },
